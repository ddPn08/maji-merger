                ...
                value=json.dumps(
                    {
                        ...
                        "model.diffusion_model.input_blocks.9": 0.5,
                        "model.diffusion_model.input_blocks.10": 0.5,
                        "model.diffusion_model.input_blocks.11": 0.5,
                        ...
                        "model.diffusion_model.output_blocks.9": 0.5,
                        "model.diffusion_model.output_blocks.10": 0.5,
                        "model.diffusion_model.output_blocks.11": 0.5,
                    }
                ),
                visible=False,
            )
